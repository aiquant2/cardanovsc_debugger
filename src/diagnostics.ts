...
// // 👉 Export diagnosticCollection globally
...
//         if (document.languageId === 'haskell' && !ghcidProcess) {
//             runGhcid();
//         }
//     });
...
// function runGhcid() {
//     ghcidProcess = spawn('ghcid', ['-c', 'cabal repl'], {
//         cwd: vscode.workspace.rootPath,
//     });

//     console.log('GHCi started');

//     let firstErrorUri: vscode.Uri | null = null;
//     let firstErrorRange: vscode.Range | null = null;

//     ghcidProcess.stdout.on('data', async (data) => {
...
//                 }
//                 range = new vscode.Range(lineNum, colNum, lineNum, colNum + errorLength);
//             } else {
...
//             const diagnostic = new vscode.Diagnostic(range, cleanedMessage, currentError.severity);

//             const existing = diagnosticsMap.get(fileUri.fsPath) || [];
//             existing.push(diagnostic);
//             diagnosticsMap.set(fileUri.fsPath, existing);

//             if (!firstErrorUri && currentError.severity === vscode.DiagnosticSeverity.Error) {
...
//             if (line.includes('Loading...') || line.includes('Ok,') || line.includes('All good')) {
//                 continue;
//             }

//             const errorMatch = line.match(/^(.+?):(\d+):(\d+)(?:-(\d+))?:\s*(error|warning):/);

//             if (errorMatch) {
//                 await flushCurrentError();
...
//                 currentError.message.push(line);
//             }
//         }
...
// // 👉 Dummy parseCabalErrors function export (you can implement your own parser logic)
// export function parseCabalErrors(output: string): vscode.Diagnostic[] {
//     const diagnostics: vscode.Diagnostic[] = [];
//     // TODO: implement actual parsing logic if needed
//     console.log('Parsing cabal errors output:', output);
//     return diagnostics;
// }
